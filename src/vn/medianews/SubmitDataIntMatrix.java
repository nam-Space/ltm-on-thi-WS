 ...
 *         &lt;element name="data" type="{http://jaxb.dev.java.net/array}intArray" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SubmitDataIntMatrix {
     ...
     * 
     */
    public List<IntArray> getData() {
        if (data == null) {
            data = new ArrayList<IntArray>();
        }
        return this.data;
    }
